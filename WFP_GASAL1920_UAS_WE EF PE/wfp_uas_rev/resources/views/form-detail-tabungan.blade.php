                            ...
                            <div class="card-header">
                             ...
                             <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    @foreach($dataTabungan as $no => $tabungan)
                                    <tr scope="row">
                                        <td>{{ $no+1 }}</td>
                                        <td>{{ $tabungan->nama }}</td>
                                        @foreach($kategori as $kategoris)
                                            ...
                                            @endif
                                        @endforeach                                      
                                        <td>{{ $tabungan->target}}</td>
                                        <td>{{ $tabungan->progres}}</td>
                                        <td>{{ $tabungan->tanggal}}</td>

                                        <td><a href="{{url('tabungan/'.$tabungan->id .'/edit')}}">Edit</a></td>
                                        <td><a href="{{url('updatetabungan/'.$tabungan->id .'/edit')}}">Update</a></td>
                                        <td>
                                            <form method="POST" action="{{ url('tabungan/' .$tabungan->id)}}" id="form-hapus-{{$tabungan->id}}" >
                                                {{csrf_field()}}
                                                {{method_field('DELETE')}}
                                                <a href="#" onclick="document.getElementById('form-hapus-{{$tabungan->id}}').submit()">Delete</a>
                                            </form>
