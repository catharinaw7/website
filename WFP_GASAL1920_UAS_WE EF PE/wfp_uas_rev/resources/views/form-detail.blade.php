            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="{{url('/laporanperbandingan')}}">Pendapatan</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="{{url('/laporanpengeluaranterbesar')}}">Pengeluaran</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="{{url('/laporanpemasukkanterbesar')}}">Tabungan</a></li>
                        </ul>
                    </li>
                    </li>
                    <li class="menu-item-has-children dropdown">
                            ...
                            <div class="card-header">
                             ...
                             <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    @foreach($input as $no => $pendapatan)
                                    <tr style = "background-color: green">
                                        <td>{{ $no+1 }}</td>
                                        <td>{{ $pendapatan->nama }}</td>
                                        <td>{{ $pendapatan->nominal}}</td>
                                        <td>{{ $pendapatan->kategori}}</td>
                                        <td>{{ $pendapatan->keterangan}}</td>

                                        <td><a href="{{url('pendapatan/'.$pendapatan->id .'/edit')}}">Edit</a></td>
                                        
                                        <td>
                                            <form method="POST" action="{{ url('pendapatan/' .$pendapatan->id)}}" id="form-hapus-{{$pendapatan->id}}" >
                                                {{csrf_field()}}
                                                {{method_field('DELETE')}}
                                                <a href="#" onclick="document.getElementById('form-hapus-{{$pendapatan->id}}').submit()">Delete</a>
                                            </form>
                                    ...
                                    @foreach($output as $no => $pengeluaran)
                                    <tr>
                                        <td>{{ $no+1 }}</td>
