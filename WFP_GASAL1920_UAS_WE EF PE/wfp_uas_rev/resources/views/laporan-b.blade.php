                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-th"></i><a href="{{url('/laporanpemasukkanterbesar')}}">Pemasukkanr</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <div class="card">
                            <div class="card-header">
                             ...
                             <div class="card-body card-block">
                                <form action="{{url('/caripengeluaran')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    @foreach($pengeluaran as $no => $pengeluarans)
                                    <tr scope="row">
                                        <td>{{ $no+1 }}</td>
                                        <td>{{ $pengeluarans->nama }}</td>
                                        <td>{{ $pengeluarans->nominal}}</td>
                                        @if($pengeluarans->kategoris_id == 1)
                                        <td>OVO</td>
                                        @endif
                                        <td></td>
                                        <td>{{ $pengeluarans->keterangan}}</td>
                                        <td>{{ $pengeluarans->created_at}}</td>
                                    </tr>
                                    @endforeach
                                    </table>
                                    </div>
