                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form method="POST" action="{{ url('pendapatan') }}" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" name="nama_pendapatan" id="text-input" placeholder="Text" class="form-control" ><small class="form-text text-muted"> Uang Jajan </small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Nominal </label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="email-input" placeholder="Masukkan Nominal" class="form-control" name="nominal_pendapatan"><small class="help-block form-text">ex. 100000</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Keterangan</label></div>
                                        <div class="col-12 col-md-9"><textarea name="ket_pendapatan" id="textarea-input" rows="9" placeholder="Keterangan Pemasukan" class="form-control"></textarea></div>
                                    </div>
                                    <div class="row form-group">
