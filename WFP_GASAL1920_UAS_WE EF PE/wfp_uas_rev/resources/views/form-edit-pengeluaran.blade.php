                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{url('pengeluaran/' .$pengeluaran->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    {{ method_field('PUT') }}
                                    <input type = "hidden" name = "_token" value = "{{csrf_token()}}" />
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label class=" form-control-label">Username</label></div>
                                        <div class="col-12 col-md-9">
                                            <p class="form-control-static" name="user">{{ Auth::user()->name }}</p>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Pengeluaran </label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="nama_pengeluaran" placeholder="Text" class="form-control" value = "{{$pengeluaran->nama}}"><small class="form-text text-muted"> Makan Siang </small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Nominal </label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="email-input" name="nominal_pengeluaran" placeholder="Masukkan Nominal" class="form-control" value="{{$pengeluaran->nominal}}"><small class="help-block form-text">ex. 100000</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Keterangan</label></div>
                                        <div class="col-12 col-md-9"><textarea name="ket_pengeluaran" id="textarea-input" rows="9" placeholder="Keterangan Pengeluaran" class="form-control">{{$pengeluaran->keterangan}}</textarea></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Kategori</label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="kategori_pengeluaran" id="select" class="form-control">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="file-input" class=" form-control-label">Photo File</label></div>
