                            ...
                            <div class="card-body card-block">
                                <form method="POST" action="{{ url('kategori') }}" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" name="name_kategori" id="text-input" placeholder="Text" class="form-control" ><small class="form-text text-muted"> ex. Cash </small></div>
                                    </div>
                                    <div class="row form-group">
