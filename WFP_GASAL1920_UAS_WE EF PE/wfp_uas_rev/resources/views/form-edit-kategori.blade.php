                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-th"></i><a href="{{url('/laporanpengeluaranterbesar')}}">Pengeluaran Terbesar</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="{{url('/laporanpemasukkanterbesar')}}">Pemasukkan Terbesar</a></li>
                        </ul>
                    </li>
                    <li>
                        <li class="menu-item-has-children dropdown">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Edit Kategori {{$kategori->name}}</strong>
                            </div>
                            <div class="card-body card-block">
                                <form method="POST" action="{{ url('kategori') }}" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" name="name_kategori" id="text-input" placeholder="{{$kategori->name}}" class="form-control" ><small class="form-text text-muted"> ex. Cash </small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Asal Pendapatan </label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="kategori_kategori" id="select" class="form-control">
                                                <option value="" disabled selected>Please select</option>
                                                <option value="pemasukan" @if($kategori->type==='pemasukan') selected='selected' @endif>Pendapatan</option>
                                                 <option value="pengeluaran" @if($kategori->type==='pengeluaran') selected='selected' @endif>Pengeluaran</option>
                                                  <option value="tabungan" @if($kategori->type==='tabungan') selected='selected' @endif>Tabungan</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!-- <div class="row form-group">
