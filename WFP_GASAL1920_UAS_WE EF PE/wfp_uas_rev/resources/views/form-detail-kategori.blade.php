                             ...
                             <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <tr scope="row">
                                        ...
                                        <td>{{ $kategoris->type}}</td>
                                        <td><a href="{{url('kategori/'.$kategoris->id .'/edit')}}">Edit</a></td>
                                        <td>
                                            <form method="POST" action="{{ url('kategori/' .$kategoris->id)}}" id="form-hapus-{{$kategoris->id}}" >
                                                {{csrf_field()}}
                                                {{method_field('DELETE')}}
                                                <a href="#" onclick="document.getElementById('form-hapus-{{$kategoris->id}}').submit()">Delete</a>
                                            </form>
