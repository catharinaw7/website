                            ...
                            <div class="card-header">
                             ...
                             <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    @foreach($dataPemasukan as $no => $pendapatan)
                                    <tr scope="row">
                                        <td>{{ $no+1 }}</td>
                                        <td>{{ $pendapatan->nama }}</td>
                                        <td>{{ $pendapatan->nominal}}</td>
                                        @foreach($kategori as $kategoris)
                                            @if($pendapatan->kategoris_id == $kategoris->id)
                                    ...
                                    <a href="{{url('/export-excelPendapatan')}}" class="btn btn-primary btn-sm" style="background-color: green; color: white">
