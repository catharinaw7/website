                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Edit Tabungan {{$tabungan->nama}}</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="{{ url('tabungan/'.$tabungan->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    {{ method_field('PUT') }}
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Tabungan </label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="nama_tabungan" placeholder="" class="form-control" value = "{{$tabungan->nama}}"><small class="form-text text-muted"> ex. Pendidikan </small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Target </label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="email-input" name="target_tabungan" placeholder="" class="form-control" value = "{{$tabungan->target}}"><small class="help-block form-text">ex. 100000</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label"> Kategori </label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="kategori_tabungan" id="select" class="form-control">
                                                @foreach($kategori as $kategoris)
                                                    @if($tabungan->kategoris_id == $kategoris->id)
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="date-input" class=" form-control-label">Deadline</label></div>
                                        <div class="col-12 col-md-9"><input type="date" id="date-input" name="deadline_tabungan" class = "form-control" value="{{$tabungan->tanggal}}"></div>
                                    </div>
