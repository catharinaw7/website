                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Buat Tabungan</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="{{ url('/tabungan') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="nama_tabungan" placeholder="" class="form-control"><small class="form-text text-muted"> ex. Pendidikan </small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Target </label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="email-input" name="target_tabungan" placeholder="" class="form-control"><small class="help-block form-text">ex. 100000</small></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="date" id="date-input" name="deadline_tabungan" class = "form-control"></div>
                                    </div>
