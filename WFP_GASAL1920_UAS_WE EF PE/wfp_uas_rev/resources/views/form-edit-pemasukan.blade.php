                    ...
                    <div class="col-sm-4">
                        <div class="page-header float-left">
                            <div class="page-title">
                                <h1>Edit Pemasukkan {{$pendapatan->nama}}</h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{url('pendapatan/'.$pendapatan->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <input type = "hidden" name = "_token" value = "{{csrf_token()}}" />
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Pendapatan </label></div>
                                        <div class="col-12 col-md-9"><input type="text" value="{{$pendapatan->nama}}" id="text-input" name="nama_pendapatan" placeholder="Text" class="form-control"><small class="form-text text-muted"> Makan Siang </small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Nominal </label></div>
                                        <div class="col-12 col-md-9"><input type="number" value="{{$pendapatan->nominal}}" id="email-input" name="nominal_pendapatan" placeholder="Masukkan Nominal" class="form-control"><small class="help-block form-text">ex. 100000</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Keterangan</label></div>
                                        <div class="col-12 col-md-9"><textarea name="ket_pendapatan"id="textarea-input" rows="9" class="form-control">{{$pendapatan->keterangan}}</textarea></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Asal Pendapatan </label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="kategori_pendapatan" id="select" class="form-control">
